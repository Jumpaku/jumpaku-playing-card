...
namespace Api_PB.V1_PB.App_PB.Authentication_PB.AuthenticationService_PB {
    ...
    public partial class AuthenticationService
    {
        ...
        public class TemporaryRegisterLogin_Result : global::App.Script.Shared.Api.IResultError {
            public global::UnityEngine.Networking.UnityWebRequest.Result result;
            public global::Api_PB.V1_PB.App_PB.Authentication_PB.TemporaryRegisterLoginResponse responseBody;
        ...
        public static async global::Cysharp.Threading.Tasks.UniTask<TemporaryRegisterLogin_Result> TemporaryRegisterLogin(
        ...
        )
        {
            ...
            {
                return new TemporaryRegisterLogin_Result
                {
            ...
            switch (uwr.result)
            {
                case global::UnityEngine.Networking.UnityWebRequest.Result.Success:
                {
                    try
                    {
                        return new TemporaryRegisterLogin_Result {
                            result = uwr.result,
                            responseBody = global::UnityEngine.JsonUtility.FromJson<global::Api_PB.V1_PB.App_PB.Authentication_PB.TemporaryRegisterLoginResponse>(outputJson)
                        };
                    }
                    catch (System.Exception e)
                    {
                ...
                default:
                    return new TemporaryRegisterLogin_Result { result = uwr.result, errorMessage = uwr.error };
            }
        }
    }
