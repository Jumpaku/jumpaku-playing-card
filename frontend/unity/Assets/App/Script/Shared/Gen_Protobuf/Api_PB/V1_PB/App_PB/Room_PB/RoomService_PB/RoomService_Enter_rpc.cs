...
namespace Api_PB.V1_PB.App_PB.Room_PB.RoomService_PB {
    ...
    public partial class RoomService
    {
        ...
        public class Enter_Result : global::App.Script.Shared.Api.IResultError {
        ...
        {
            string urlPath = $"/api/v1/app/room/{(global::UnityEngine.Networking.UnityWebRequest.EscapeURL(input?.roomId))}/enter";
            string urlQuery = "";
            ...
            switch (uwr.result)
            {
                ...
                default:
                    return new Enter_Result { result = uwr.result, errorMessage = uwr.error };
            }
        }
    }
