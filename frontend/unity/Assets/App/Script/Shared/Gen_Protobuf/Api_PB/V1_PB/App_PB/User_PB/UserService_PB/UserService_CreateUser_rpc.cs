...
namespace Api_PB.V1_PB.App_PB.User_PB.UserService_PB {
    ...
    public partial class UserService
    {
        ...
        public class CreateUser_Result : global::App.Script.Shared.Api.IResultError {
            public global::UnityEngine.Networking.UnityWebRequest.Result result;
            public global::Api_PB.V1_PB.App_PB.User_PB.CreateUserResponse responseBody;
        ...
        public static async global::Cysharp.Threading.Tasks.UniTask<CreateUser_Result> CreateUser(
            ...
            switch (uwr.result)
            {
                case global::UnityEngine.Networking.UnityWebRequest.Result.Success:
                {
                    try
                    {
                        return new CreateUser_Result {
                            result = uwr.result,
                            responseBody = global::UnityEngine.JsonUtility.FromJson<global::Api_PB.V1_PB.App_PB.User_PB.CreateUserResponse>(outputJson)
                        };
                    }
                    catch (System.Exception e)
                    {
                ...
                default:
                    return new CreateUser_Result { result = uwr.result, errorMessage = uwr.error };
            }
        }
    }
