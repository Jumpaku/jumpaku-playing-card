...
namespace Api_PB.V1_PB.App_PB.Room_PB.RoomService_PB {
    ...
    public partial class RoomService
    {
        ...
        public class TakeSeat_Result : global::App.Script.Shared.Api.IResultError {
            public global::UnityEngine.Networking.UnityWebRequest.Result result;
            public global::Api_PB.V1_PB.App_PB.Room_PB.TakeSeatResponse responseBody;
        ...
        public static async global::Cysharp.Threading.Tasks.UniTask<TakeSeat_Result> TakeSeat(
        ...
        {
            string urlPath = $"/api/v1/app/room/{(global::UnityEngine.Networking.UnityWebRequest.EscapeURL(input?.roomId))}/seat/{(global::UnityEngine.Networking.UnityWebRequest.EscapeURL(input?.seatId))}/take";
            string urlQuery = "";
            ...
            switch (uwr.result)
            {
                case global::UnityEngine.Networking.UnityWebRequest.Result.Success:
                {
                    try
                    {
                        return new TakeSeat_Result {
                            result = uwr.result,
                            responseBody = global::UnityEngine.JsonUtility.FromJson<global::Api_PB.V1_PB.App_PB.Room_PB.TakeSeatResponse>(outputJson)
                        };
                    }
                    catch (System.Exception e)
                    {
                ...
                default:
                    return new TakeSeat_Result { result = uwr.result, errorMessage = uwr.error };
            }
        }
    }
