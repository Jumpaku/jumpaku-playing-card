...
//     source: api.v1.example.ExampleService.DeleteExample(api/v1/example/example.proto)
// </auto-generated>
...
namespace Api_PB.V1_PB.Example_PB.ExampleService_PB {
    ...
    public partial class ExampleService
    {
        ...
        public class DeleteExample_Result : global::App.Script.Shared.Api.IResultError {
            public global::UnityEngine.Networking.UnityWebRequest.Result result;
            public global::Api_PB.V1_PB.Example_PB.DeleteExampleResponse responseBody;
        ...
        public static async global::Cysharp.Threading.Tasks.UniTask<DeleteExample_Result> DeleteExample(
            global::App.Script.Shared.Api.ISession session,
            global::Api_PB.V1_PB.Example_PB.DeleteExampleRequest input,
        ...
        )
        {
            ...
            {
                return new DeleteExample_Result
                {
            ...
            switch (uwr.result)
            {
                case global::UnityEngine.Networking.UnityWebRequest.Result.Success:
                {
                    try
                    {
                        return new DeleteExample_Result {
                            result = uwr.result,
                            responseBody = global::UnityEngine.JsonUtility.FromJson<global::Api_PB.V1_PB.Example_PB.DeleteExampleResponse>(outputJson)
                        };
                    }
                    catch (System.Exception e)
                    {
                ...
                default:
                    return new DeleteExample_Result { result = uwr.result, errorMessage = uwr.error };
            }
        }
    }
