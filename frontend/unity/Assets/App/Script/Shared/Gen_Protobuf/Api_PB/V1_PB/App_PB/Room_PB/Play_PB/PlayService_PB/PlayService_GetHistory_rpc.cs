...
namespace Api_PB.V1_PB.App_PB.Room_PB.Play_PB.PlayService_PB {
    ...
    public partial class PlayService {
        public class GetHistory : global::App.Script.Shared.Api.ICaller<global::Api_PB.V1_PB.App_PB.Room_PB.Play_PB.GetHistoryResponse> {
            public GetHistory(
            ...
            private global::Api_PB.V1_PB.App_PB.Room_PB.Play_PB.GetHistoryRequest _input;
            ...
            {
                string urlPath = $"/api/v1/app/room/{(global::UnityEngine.Networking.UnityWebRequest.EscapeURL(_input?.roomId))}/play/history";
                string urlQuery = $"?{(_input?.seekHistoryEntryOrder == null ? "" : global::UnityEngine.Networking.UnityWebRequest.EscapeURL($"seekHistoryEntryOrder={_input?.seekHistoryEntryOrder}"))}&{(_input?.limit == null ? "" : global::UnityEngine.Networking.UnityWebRequest.EscapeURL($"limit={_input?.limit}"))}";
            ...
            public async global::Cysharp.Threading.Tasks.UniTask<global::App.Script.Shared.Api.CallResult<global::Api_PB.V1_PB.App_PB.Room_PB.Play_PB.GetHistoryResponse>> Call(string baseUrl)
            {
                ...
                {
                    return new global::App.Script.Shared.Api.CallResult<global::Api_PB.V1_PB.App_PB.Room_PB.Play_PB.GetHistoryResponse>()
                    {
                        ...
                        try
                        {
                            return new global::App.Script.Shared.Api.CallResult<global::Api_PB.V1_PB.App_PB.Room_PB.Play_PB.GetHistoryResponse>()
                            {
                                ...
                                Value = global::UnityEngine.JsonUtility
                                    .FromJson<global::Api_PB.V1_PB.App_PB.Room_PB.Play_PB.GetHistoryResponse>(
                                        ResponseBody)
                            };
                        }
                        catch (System.Exception e)
