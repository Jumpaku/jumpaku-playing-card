...
namespace Api_PB.V1_PB.App_PB.User_PB.UserService_PB {
    ...
    public partial class UserService
    {
        ...
        public class RemoveUserAuthentication_Result : global::App.Script.Shared.Api.IResultError {
        ...
        {
            string urlPath = $"/api/v1/app/user/{(global::UnityEngine.Networking.UnityWebRequest.EscapeURL(input?.userId))}/authentication";
            string urlQuery = "";
            ...
            switch (uwr.result)
            {
                ...
                default:
                    return new RemoveUserAuthentication_Result { result = uwr.result, errorMessage = uwr.error };
            }
        }
    }
