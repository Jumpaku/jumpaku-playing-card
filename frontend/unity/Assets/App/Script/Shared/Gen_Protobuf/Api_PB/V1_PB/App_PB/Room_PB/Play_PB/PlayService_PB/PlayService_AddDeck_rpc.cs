...
namespace Api_PB.V1_PB.App_PB.Room_PB.Play_PB.PlayService_PB {
    ...
    public partial class PlayService {
        public class AddDeck : global::App.Script.Shared.Api.ICaller<global::Api_PB.V1_PB.App_PB.Room_PB.Play_PB.AddDeckResponse> {
            public AddDeck(
            ...
            private global::Api_PB.V1_PB.App_PB.Room_PB.Play_PB.AddDeckRequest _input;
            ...
            {
                string urlPath = $"/api/v1/app/room/{(global::UnityEngine.Networking.UnityWebRequest.EscapeURL(_input?.roomId))}/play/place/{(global::UnityEngine.Networking.UnityWebRequest.EscapeURL(_input?.placeId))}/deck";
                string urlQuery = "";
            ...
            public async global::Cysharp.Threading.Tasks.UniTask<global::App.Script.Shared.Api.CallResult<global::Api_PB.V1_PB.App_PB.Room_PB.Play_PB.AddDeckResponse>> Call(string baseUrl)
            {
                ...
                {
                    return new global::App.Script.Shared.Api.CallResult<global::Api_PB.V1_PB.App_PB.Room_PB.Play_PB.AddDeckResponse>()
                    {
                        ...
                        try
                        {
                            return new global::App.Script.Shared.Api.CallResult<global::Api_PB.V1_PB.App_PB.Room_PB.Play_PB.AddDeckResponse>()
                            {
                                ...
                                Response = global::UnityEngine.JsonUtility
                                    .FromJson<global::Api_PB.V1_PB.App_PB.Room_PB.Play_PB.AddDeckResponse>(
                                        ResponseBody)
                            };
                        }
                        catch (System.Exception e)
