...
namespace Api_PB.V1_PB.App_PB.Room_PB.Play_PB.PlayService_PB {
    ...
    public partial class PlayService
    {
        ...
        public class AddDeck_Result : global::App.Script.Shared.Api.IResultError {
        ...
        {
            string urlPath = $"/api/v1/app/room/{(global::UnityEngine.Networking.UnityWebRequest.EscapeURL(input?.roomId))}/play/place/{(global::UnityEngine.Networking.UnityWebRequest.EscapeURL(input?.placeId))}/deck";
            string urlQuery = "";
            ...
            switch (uwr.result)
            {
                ...
                default:
                    return new AddDeck_Result { result = uwr.result, errorMessage = uwr.error };
            }
        }
    }
