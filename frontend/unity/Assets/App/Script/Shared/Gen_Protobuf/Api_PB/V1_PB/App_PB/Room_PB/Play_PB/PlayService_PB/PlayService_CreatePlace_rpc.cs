...
namespace Api_PB.V1_PB.App_PB.Room_PB.Play_PB.PlayService_PB {
    ...
    public partial class PlayService
    {
        ...
        public class CreatePlace_Result : global::App.Script.Shared.Api.IResultError {
            public global::UnityEngine.Networking.UnityWebRequest.Result result;
            public global::Api_PB.V1_PB.App_PB.Room_PB.Play_PB.CreatePlaceResponse responseBody;
        ...
        public static async global::Cysharp.Threading.Tasks.UniTask<CreatePlace_Result> CreatePlace(
            ...
            switch (uwr.result)
            {
                case global::UnityEngine.Networking.UnityWebRequest.Result.Success:
                {
                    try
                    {
                        return new CreatePlace_Result {
                            result = uwr.result,
                            responseBody = global::UnityEngine.JsonUtility.FromJson<global::Api_PB.V1_PB.App_PB.Room_PB.Play_PB.CreatePlaceResponse>(outputJson)
                        };
                    }
                    catch (System.Exception e)
                    {
                ...
                default:
                    return new CreatePlace_Result { result = uwr.result, errorMessage = uwr.error };
            }
        }
    }
