...
namespace Api_PB.V1_PB.App_PB.Room_PB.RoomService_PB {
    ...
    public partial class RoomService
    {
        ...
        public class Create_Result : global::App.Script.Shared.Api.IResultError {
            public global::UnityEngine.Networking.UnityWebRequest.Result result;
            public global::Api_PB.V1_PB.App_PB.Room_PB.CreateResponse responseBody;
        ...
        public static async global::Cysharp.Threading.Tasks.UniTask<Create_Result> Create(
            ...
            switch (uwr.result)
            {
                case global::UnityEngine.Networking.UnityWebRequest.Result.Success:
                {
                    try
                    {
                        return new Create_Result {
                            result = uwr.result,
                            responseBody = global::UnityEngine.JsonUtility.FromJson<global::Api_PB.V1_PB.App_PB.Room_PB.CreateResponse>(outputJson)
                        };
                    }
                    catch (System.Exception e)
                    {
                ...
                default:
                    return new Create_Result { result = uwr.result, errorMessage = uwr.error };
            }
        }
    }
