...
namespace Api_PB.V1_PB.App_PB.Room_PB.Play_PB.PlayService_PB {
    ...
    public partial class PlayService {
        public class DeletePlace : global::App.Script.Shared.Api.ICaller<global::Api_PB.V1_PB.App_PB.Room_PB.Play_PB.DeletePlaceResponse> {
            public DeletePlace(
            ...
            private global::Api_PB.V1_PB.App_PB.Room_PB.Play_PB.DeletePlaceRequest _input;
            ...
            {
                string urlPath = $"/api/v1/app/room/{(global::UnityEngine.Networking.UnityWebRequest.EscapeURL(_input?.roomId))}/play/place/{(global::UnityEngine.Networking.UnityWebRequest.EscapeURL(_input?.placeId))}";
                string urlQuery = "";
            ...
            public async global::Cysharp.Threading.Tasks.UniTask<global::App.Script.Shared.Api.CallResult<global::Api_PB.V1_PB.App_PB.Room_PB.Play_PB.DeletePlaceResponse>> Call(string baseUrl)
            {
                ...
                {
                    return new global::App.Script.Shared.Api.CallResult<global::Api_PB.V1_PB.App_PB.Room_PB.Play_PB.DeletePlaceResponse>()
                    {
                        ...
                        try
                        {
                            return new global::App.Script.Shared.Api.CallResult<global::Api_PB.V1_PB.App_PB.Room_PB.Play_PB.DeletePlaceResponse>()
                            {
                                ...
                                Value = global::UnityEngine.JsonUtility
                                    .FromJson<global::Api_PB.V1_PB.App_PB.Room_PB.Play_PB.DeletePlaceResponse>(
                                        ResponseBody)
                            };
                        }
                        catch (System.Exception e)
