...
namespace Api_PB.V1_PB.App_PB.User_PB.UserService_PB {
    ...
    public partial class UserService
    {
        ...
        public class GetUser_Result : global::App.Script.Shared.Api.IResultError {
            public global::UnityEngine.Networking.UnityWebRequest.Result result;
            public global::Api_PB.V1_PB.App_PB.User_PB.GetUserResponse responseBody;
        ...
        public static async global::Cysharp.Threading.Tasks.UniTask<GetUser_Result> GetUser(
        ...
        {
            string urlPath = $"/api/v1/app/user/{(global::UnityEngine.Networking.UnityWebRequest.EscapeURL(input?.userId))}";
            string urlQuery = $"?";
            ...
            switch (uwr.result)
            {
                case global::UnityEngine.Networking.UnityWebRequest.Result.Success:
                {
                    try
                    {
                        return new GetUser_Result {
                            result = uwr.result,
                            responseBody = global::UnityEngine.JsonUtility.FromJson<global::Api_PB.V1_PB.App_PB.User_PB.GetUserResponse>(outputJson)
                        };
                    }
                    catch (System.Exception e)
                    {
                ...
                default:
                    return new GetUser_Result { result = uwr.result, errorMessage = uwr.error };
            }
        }
    }
