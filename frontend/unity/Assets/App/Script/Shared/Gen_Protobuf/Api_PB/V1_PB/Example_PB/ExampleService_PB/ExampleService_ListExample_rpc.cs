...
namespace Api_PB.V1_PB.Example_PB.ExampleService_PB {
    ...
    public partial class ExampleService {
        public class ListExample : global::App.Script.Shared.Api.ICaller<global::Api_PB.V1_PB.Example_PB.ListExampleResponse> {
            public ListExample(
            ...
            private global::Api_PB.V1_PB.Example_PB.ListExampleRequest _input;
            ...
            public string RequestUrl(string baseUrl)
            {
                ...
                string urlQuery = $"?{(_input?.desc == null ? "" : global::UnityEngine.Networking.UnityWebRequest.EscapeURL($"desc={_input?.desc}"))}&{(_input?.limit == null ? "" : global::UnityEngine.Networking.UnityWebRequest.EscapeURL($"limit={_input?.limit}"))}&{(_input?.offset == null ? "" : global::UnityEngine.Networking.UnityWebRequest.EscapeURL($"offset={_input?.offset}"))}";
            ...
            public async global::Cysharp.Threading.Tasks.UniTask<global::App.Script.Shared.Api.CallResult<global::Api_PB.V1_PB.Example_PB.ListExampleResponse>> Call(string baseUrl)
            {
                ...
                {
                    return new global::App.Script.Shared.Api.CallResult<global::Api_PB.V1_PB.Example_PB.ListExampleResponse>()
                    {
                        ...
                        try
                        {
                            return new global::App.Script.Shared.Api.CallResult<global::Api_PB.V1_PB.Example_PB.ListExampleResponse>()
                            {
                                ...
                                Value = global::UnityEngine.JsonUtility
                                    .FromJson<global::Api_PB.V1_PB.Example_PB.ListExampleResponse>(
                                        ResponseBody)
                            };
                        }
                        catch (System.Exception e)
