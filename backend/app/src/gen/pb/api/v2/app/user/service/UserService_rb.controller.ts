...
import { CreateUserRequestSchema, CreateUserResponseSchema, GetUserRequestSchema, GetUserResponseSchema } from "../service_pb.js";

@Controller() 
export class UserServiceController {
  constructor(private service: UserServiceService) {}

  @Post('/api/v2/app/user')
