...
import { UserModule } from './controller/api/v2/app/user/user.module';
import { RoomModule } from './controller/api/v2/app/room/room.module';
import { PlayModule } from './controller/api/v2/app/room/play/play.module';
