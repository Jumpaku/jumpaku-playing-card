...
export class PlayServiceController {
  ...
  @AccessControl({
    scopePath: "api.v1.app.room.play.PlayService.ListPlace",
    require: [
      "play:place",
    ]
  }) 
  ...
  @AccessControl({
    scopePath: "api.v1.app.room.play.PlayService.CreatePlace",
    require: [
      "play:place",
    ]
  }) 
  ...
  @AccessControl({
    scopePath: "api.v1.app.room.play.PlayService.DeletePlace",
    require: [
      "play:place",
    ]
  }) 
  ...
  @AccessControl({
    scopePath: "api.v1.app.room.play.PlayService.AddDeck",
    require: [
      "play:card",
    ]
  }) 
  ...
  @AccessControl({
    scopePath: "api.v1.app.room.play.PlayService.MoveCard",
    require: [
      "play:card",
    ]
  }) 
  ...
  @AccessControl({
    scopePath: "api.v1.app.room.play.PlayService.GetHistory",
    require: [
      "play:card",
    ]
  }) 
